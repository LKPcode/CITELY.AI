  ...
  <div class="mt-4 ">
    <div class="sm:flex sm:items-center">
      ...
      <div class="flex items-center rounded-md border border-accent cursor-pointer">
        <button @click="addPapers" type="button"
          class="block  px-3 py-1.5 text-center text-sm leading-6 text-grayest shadow-sm  focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-accent">
            ...
            <table class="min-w-full table-fixed divide-y divide-gray-300">
              ...
              <thead class="">
                ...
                <tr class="bg-white z-20">
                  ...
                  <th scope="col"
                    class="px-3 py-3.5 text-left text-sm font-semibold text-gray-900 sticky top-0 bg-white z-20">Authors
                  </th>
                  <th scope="col"
              ...
              <tbody class="divide-y divide-gray-200 bg-white overflow-scroll ">
                <tr @click="paper_store.selectPaper(paper)" v-for="paper in paper_store.paper_list.value" :key="paper.id"
