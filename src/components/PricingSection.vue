  ...
  <div class="mx-auto max-w-7xl px-6 lg:px-8">
    ...
    <div class="isolate mx-auto mt-16 grid max-w-md grid-cols-1 gap-y-8 sm:mt-20 lg:mx-0 lg:max-w-none lg:grid-cols-3">
      <div class="flex flex-col justify-between rounded-3xl bg-white p-8 ring-1 ring-gray-200 xl:p-10 lg:mt-8 lg:rounded-r-none">
        <div>
          ...
          <ul role="list" class="mt-8 space-y-3 text-sm leading-6 text-gray-600">
            <li class="flex gap-x-3">
              <svg class="h-6 w-5 flex-none text-accent" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
        ...
        <a href="#" aria-describedby="tier-freelancer" class="mt-8 block rounded-md py-2 px-3 text-center text-sm font-semibold leading-6 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-accent text-accent ring-1 ring-inset ring-accent/50  hover:ring-accent">
          Current Plan
        </a>
      </div>
      <div class="flex flex-col justify-between rounded-3xl bg-white p-8 ring-1 ring-gray-200 xl:p-10 lg:z-10 lg:rounded-b-none">
        <div>
          <div class="flex items-center justify-between gap-x-4">
            ...
            <p class="rounded-full bg-accent/10 px-2.5 py-1 text-xs font-semibold leading-5 text-accent">Most popular</p>
          </div>
        ...
        <button @click="checkout" aria-describedby="tier-startup" class="mt-8 block rounded-md py-2 px-3 text-center text-sm font-semibold leading-6 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-accent bg-accent text-white shadow-md hover:bg-accent/90">
          Buy plan</button>
      </div>
      <div class="flex flex-col justify-between rounded-3xl bg-white p-8 ring-1 ring-gray-200 xl:p-10 lg:mt-8 lg:rounded-l-none">
        ...
        <a href="#" aria-describedby="tier-enterprise" class="mt-8 block rounded-md py-2 px-3 text-center text-sm font-semibold leading-6 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-accent text-accent ring-1 ring-inset ring-accent/50  hover:ring-accent">Buy plan</a>
      </div>
    </div>
  </div>
</div>
...
import payment_api from '../api/payment_api'

const { getCheckoutSession } = payment_api

const checkout = async () => {
  let session = await getCheckoutSession("price_1Nb27ACAM4gFDCpw1oDIvGIH")
