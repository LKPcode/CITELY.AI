<template>
  ...
  <div   class="-mt-px flex w-0 flex-1 cursor-pointer">
    <a @click="emits('previousPage')" v-if="page_num > 0"  class="inline-flex items-center border-t-2 border-transparent pr-1 pt-4 text-sm font-medium text-gray-500 hover:border-gray-300 hover:text-gray-700">
  ...
  <div  class="-mt-px flex w-0 flex-1 justify-end">
    <a @click="emits('nextPage')" v-if="total_papers > 20*(page_num+1)"  class="inline-flex cursor-pointer items-center border-t-2 border-transparent pl-1 pt-4 text-sm font-medium text-gray-500 hover:border-gray-300 hover:text-gray-700">
      Next
